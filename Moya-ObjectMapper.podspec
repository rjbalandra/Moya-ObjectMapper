Pod::Spec.new do |s|
  ...
  EOS
  s.homepage     = "https://github.com/rjbalandra/Moya-ObjectMapper"
  ...
  s.source       = { :git => "https://github.com/rjbalandra/Moya-ObjectMapper.git", :tag => s.version }
  ...
  s.subspec "Core" do |ss|
    ...
    ss.dependency "ObjectMapper-Custom", "~> 4.2.1"
